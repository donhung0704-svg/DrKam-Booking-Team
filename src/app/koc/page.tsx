...
const statusOptions = ["Chờ phản hồi", "Đã phản hồi", "Đã chốt", "Từ chối"];
...
const filterFields: FilterField[] = [
  ...
  { key: "number_of_videos", label: "Number of videos", field: "number_of_videos", type: "number" },
  { key: "campaign_id", label: "Campaign name", field: "campaign_id", type: "select", relation: "campaign" },
  { key: "gmv", label: "GMV", field: "gmv", type: "number" },
...
const columnOptions: ColumnOption[] = [
  ...
  { key: "number_of_videos", label: "Number of videos" },
  ...
  function exportKocExcel() {
    const exportRows = kocs.map((koc) => {
      ...
      return {
        ...
        "Number of videos": formatNumber(koc.number_of_videos),
        "Campaign name": campaignName === "-" ? "" : campaignName,
        GMV: Number(koc.gmv || 0),
