...
const statusOptions = ["Chờ phản hồi", "Đã phản hồi", "Cân nhắc", "Đã chốt", "Từ chối", "Trùng KOC", "Dừng CS"];
...
const filterFields: FilterField[] = [
  ...
  { key: "videos_with_revenue", label: "Video có DT", field: "videos_with_revenue", type: "number" },
...
const columnOptions: ColumnOption[] = [
  ...
  { key: "videos_with_revenue", label: "Video có DT", defaultVisible: true },
  ...
  async function exportKocExcel() {
    ...
    try {
      ...
      const exportRows = allKocs.map((koc) => {
        ...
        "Video có DT": formatNumber(koc.videos_with_revenue),
